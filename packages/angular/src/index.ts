...
import type { HttpHandler, HttpInterceptor, HttpRequest, HttpEvent } from "@angular/common/http";
    ...
    intercept(req: HttpRequest<any>, next: HttpHandler): Observable<HttpEvent<any>> {
      ...
      if (transformRequest) {
        ...
        requestData = { 
          ...requestData, 
          ...transformed,
          method: (transformed.method || requestData.method) as Schmock.HttpMethod
        };
      }
